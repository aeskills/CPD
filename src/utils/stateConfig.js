...
export const STATES = [
  ...
  { id: "rajasthan", code: "RJ", name: "Rajasthan", path: "/rajasthan" },
...
export const STATE_CONFIGS = {
  ...
  rajasthan: {
    ...
    code: "RJ",
    name: "Rajasthan",
    schedulerUrl: "https://aeskills.github.io/CPD-Scheduler/RJ",
    cpdUrl: "https://aeskills.github.io/CPD/rajasthan",
    title: "CPD Foundation Program — Rajasthan",
    heroTitleHighlight: "teaching practice in Rajasthan",
  },
  rj: {
    id: "rajasthan",
    code: "RJ",
